...
// @ts-ignore
const sbUrl = isDev ? Deno.env.get('LOCAL_SUPABASE_URL') : Deno.env.get('SUPABASE_URL');

// @ts-ignore
const anonKey = isDev ? Deno.env.get('LOCAL_SUPABASE_ANON_KEY') : Deno.env.get('SUPABASE_ANON_KEY');
