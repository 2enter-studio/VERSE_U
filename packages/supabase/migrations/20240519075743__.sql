...
alter table "public"."chat_members" drop constraint "j-chats-users_pkey";

drop index if exists "public"."j-chats-users_pkey";

alter table "public"."chat_members" alter column "user" set default auth.uid();

alter table "public"."profiles" drop column "coins";

alter table "public"."profiles" drop column "exp";

alter table "public"."wearing_types" alter column "value" set default gen_random_text(5);

CREATE UNIQUE INDEX chat_members_pkey ON public.chat_members USING btree (chat, "user");
